...
<head>
  ...
  <title>LCleaned | Dashboard Admin</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('adm/dist/img/avatar10.png') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item active">
             <a href="{{ url('/admin/list-datalaundry') }}" class="nav-link">
              <i class="nav-icon fas fa-store"></i>
              <p>List Toko Laundry</p>
            </a>
          </li>
          <li class="nav-item active">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="http://revanofabiansyahpriadi.my.id/ ">LCleaned</a>.</strong>
    All rights reserved.
