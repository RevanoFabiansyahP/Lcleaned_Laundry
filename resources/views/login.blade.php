...
<div class="login-box">
  ...
  <div class="card" style ="position: relative; left: 60%">
    <div class="card-body login-card-body">
      <b><p style="color: #22bdff" class="login-box-msg">Masuk Ke Akunmu</p></b>
        ...
        <div class="row">
          <div class="col-8">
            <div class="icheck-primary">
              ...
              <label style="color: #22bdff" for="remember">
                Ingatkan username saya
              </label>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
            <button  style="background-color: #22bdff; color: white; border-color:#22bdff; " type="submit" class="btn btn-warning btn-block" >Masuk</button>
          </div>
      ...
      <div class="row" style="margin-top: 30px;">
        <p class="col-6">
          <a style="color: #22bdff;" href="lupa-password">Lupa Password ?</a>
        </p>
        <p class="col-6">  
          <a style="color: #22bdff;" href="register" class="">Registrasi Akun Baru</a>
        </p>
        <p class="col-6">  
          <a style="color: #22bdff;" href="admin/login"class="">Login Sebagai Admin</a>
        </p>
        <p class="col-6">  
          <a style="color: #22bdff;" href="mitra/login"class="">Login Sebagai Mitra</a>
        </p>
      </div>
    </div>
    <!-- /.login-card-body -->
